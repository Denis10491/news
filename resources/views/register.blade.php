            ...
            <div class="bg-white w-96 shadow-xl rounded p-5">
                ...
                <form action="{{ route('api.auth.register')  }}" class="space-y-5 mt-5" method="POST">
                    ...
                    <label for="name">
                        ...
                        <input value="{{ old('name') }}" name="name" type="text" class="w-full h-12 border border-gray-800 rounded px-3 mb-5 @error('name') border-red-500 @enderror" placeholder="Имя" />
                    </label>
                    ...
                    <label for="password_confirmation">
                        ...
                        <input value="{{ old('password_confirmation') }}" name="password_confirmation" type="password" class="w-full h-12 border border-gray-800 rounded px-3 mb-5 @error('password_confirmation') border-red-500 @enderror" placeholder="Подтверждение пароля" />
                    </label>

                    <div>
                        <a href="{{ route('auth.login.index') }}" class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Есть аккаунт?</a>
                    </div>
